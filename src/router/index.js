...
const routes = [
  ...
  // 教学中心模块 (懒加载)
  {
    ...
    children: [
      ...
      { path: 'classes/settings/:id', name: 'TeachingCenter-ClassSettings', component: () => import('../views/teaching-center/classes/ClassSettings.vue') },
      { path: 'classes/members/:id', name: 'TeachingCenter-MemberManagement', component: () => import('../views/teaching-center/classes/MemberManagement.vue') },
      { path: 'courses', name: 'TeachingCenter-Courses', component: () => import('../views/teaching-center/courses/Courses.vue') },
      { path: 'courses/provision/:id', name: 'TeachingCenter-CourseProvision', component: () => import('../views/teaching-center/courses/CurriculumProvision.vue') },
      { path: 'courses/statistics/:id', name: 'TeachingCenter-CourseStatistics', component: () => import('../views/teaching-center/courses/CourseStatistics.vue') },
      { path: 'practice', name: 'TeachingCenter-Practice', component: () => import('../views/teaching-center/practice/Practice.vue') },
      { path: 'practice/settings/:id', name: 'TeachingCenter-PracticeSettings', component: () => import('../views/teaching-center/practice/PracticeSettings.vue') },
      { path: 'exams', name: 'TeachingCenter-Exams', component: () => import('../views/teaching-center/exams/Exams.vue') },
      { path: 'exam-settings/:id', name: 'TeachingCenter-ExamSettings', component: () => import('../views/teaching-center/exams/ExamSettings.vue') },
      { path: 'exam-marking/:id', name: 'TeachingCenter-ExamMarking', component: () => import('../views/teaching-center/exams/ExamMarking.vue') },
      { path: 'grade-paper/:id', name: 'TeachingCenter-GradePaper', component: () => import('../views/teaching-center/exams/GradePaper.vue') },
      ...
      { path: 'question/manual-add', name: 'TeachingCenter-ManualAddQuestion', component: () => import('../views/teaching-center/question_bank/ManualAddQuestion.vue') },
      { path: 'range', name: 'TeachingCenter-ShootingRange', component: () => import('../views/teaching-center/range/ShootingRange.vue') },
      { path: 'range/rangesetup/:id', name: 'TeachingCenter-ShootingRangeSetup', component: () => import('../views/teaching-center/range/RangeSetup.vue') },
      { path: 'range/rangemarking/:id', name: 'TeachingCenter-ShootingRangeMarking', component: () => import('../views/teaching-center/range/RangeMarking.vue') },
      { path: 'range/rangegradepaper/:id', name: 'TeachingCenter-ShootingRangeGradePaper', component: () => import('../views/teaching-center/range/RangeGradePaper.vue') },
  ...
  // 系统管理模块 (懒加载)
  {
    ...
    children: [
      ...
      { path: 'certificate-settings', name: 'System-CertificateSettings', component: () => import('../views/system-management/CertificateManagement/CertificateSettings.vue') },
      { path: 'certificate-settings/:id', name: 'System-CertificateEdit', component: () => import('../views/system-management/CertificateManagement/CertificateSettings.vue') },
