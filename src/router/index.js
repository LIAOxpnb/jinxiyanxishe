...
const routes = [
  ...
  // 教学中心模块 (懒加载)
  {
    ...
    children: [
      ...
      { path: 'courses', name: 'TeachingCenter-Courses', component: () => import('../views/teaching-center/Courses.vue') },
      { path: 'practice', name: 'TeachingCenter-Practice', component: () => import('../views/teaching-center/Practice.vue') },
      { path: 'exams', name: 'TeachingCenter-Exams', component: () => import('../views/teaching-center/Exams.vue') },
      { path: 'exam-settings/:id', name: 'TeachingCenter-ExamSettings', component: () => import('../views/teaching-center/ExamSettings.vue') },
      { path: 'exam-marking/:id', name: 'TeachingCenter-ExamMarking', component: () => import('@/views/teaching-center/ExamMarking.vue') },
      { path: 'grade-paper/:id', name: 'TeachingCenter-GradePaper', component: () => import('@/views/teaching-center/GradePaper.vue') },
      { path: 'question-bank', name: 'TeachingCenter-QuestionBank', component: () => import('../views/teaching-center/QuestionBank.vue') },
      { path: 'question/manual-add', name: 'TeachingCenter-ManualAddQuestion', component: () => import('../views/teaching-center/ManualAddQuestion.vue') },
      { path: 'shooting-range', name: 'TeachingCenter-ShootingRange', component: () => import('../views/teaching-center/ShootingRange.vue') },
      { path: 'handouts', name: 'TeachingCenter-Handouts', component: () => import('../views/teaching-center/Handouts.vue') },
